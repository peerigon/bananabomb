 ...
 * @param {lib.twitter.TwitterSignature} twitterSignature
 * @param (lib.OAuthTools) oAuthTools (optional for tests)
 * @param {node.https} nodeHttps (optional for tests)
 *
 * @return (Twitter)
 */
function Twitter(twitterUser, twitterConsumer, twitterSignature, oAuthTools, nodeHttps) {
    ...
    function __construct() {
        if (!twitterUser || !twitterConsumer || !twitterSignature) {
