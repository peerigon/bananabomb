 ...
 * @param oAuthTools (OAuthTools)
 * @param twitterSignature (TwitterSignature)
 * @param nodeHttps (node.https)
 *
 * @return (Twitter)
 */
module.exports = function Twitter(twitterUser, twitterConsumer, twitterSignature, oAuthTools, nodeHttps) {
    ...
    function __construct() {
        if (!twitterUser || !twitterConsumer || !twitterSignature || !oAuthTools) {
            throw new Error("You must provide an instance of TwitterUser, TwitterConsumer, TwitterSignature and oAuthTools on construction.");
        }
        https           = nodeHttps || require("https");
